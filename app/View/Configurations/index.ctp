<div class="configurations index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('max_opened_complaints'); ?></th>
			<th><?php echo $this->Paginator->sort('max_reply_time'); ?></th>
			<th class="actions"><?php echo __('Actions'); ?></th>
	</tr>
	<?php foreach ($configurations as $configuration): ?>
	<tr>
		<td><?php echo h($configuration['Configuration']['id']); ?>&nbsp;</td>
		<td><?php echo h($configuration['Configuration']['max_opened_complaints']); ?>&nbsp;</td>
		<td><?php echo h($configuration['Configuration']['max_reply_time']); ?>&nbsp;</td>
		<td class="actions">
