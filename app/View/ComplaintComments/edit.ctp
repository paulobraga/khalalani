...
<?php echo $this->Form->create('ComplaintComment'); ?>
	<fieldset>
		<legend><?php echo __('Edit Complaint Comment'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ComplaintComment.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ComplaintComment.id'))); ?></li>
