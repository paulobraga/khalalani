<div class="messages index">
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($message['Group']['name'], array('controller' => 'groups', 'action' => 'view', $message['Group']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($message['Complaint']['id'], array('controller' => 'complaints', 'action' => 'view', $message['Complaint']['id'])); ?>
		</td>
