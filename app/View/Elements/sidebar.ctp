		...
		<aside>
			<div class="top">
				...
				<nav><ul class="collapsible accordion">
					...
					<li class="current"><a href="dashboard.html"><img src="/khalalani/img/mangoadmin/img/icons/packs/fugue/16x16/dashboard.png" alt="" height=16 width=16>Dashboard</a></li>
					<li>
