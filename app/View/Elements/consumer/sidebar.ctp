...
<!--                                        <li>
						...
						<ul>
							...
							<li><a href="<?php echo $this->Html->url(array('controller'=>'complaints','action'=>'listByConsumerId'));?>"><span class="icon icon-list"></span><?php echo __('My Complaints');?></a></li>
					...
					<li>
						...
						<ul>
							<li><a href="<?php echo $this->Html->url(array('controller'=>'complaintcategories','action'=>'listByCompanyId'));?>"><?php echo __('Privacy');?></a></li>
							<li><a href="<?php echo $this->Html->url(array('controller'=>'companies','action'=>'view',$this->Session->read('Auth.User.Manager.company_id')));?>"><?php echo __('Account');?></a></li>
