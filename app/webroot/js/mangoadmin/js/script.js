    ...
    mango.loaded(function() {
        ...
        $('.uploader').each(function() {
            ...
            $uploader.pluploadQueue($.extend({
                ...
                flash_swf_url: '/khalalani/js/mangoadmin/js/mylibs/forms/uploader/plupload.flash.swf'
            }, $uploader.data()));
    ...
    mango.utils.tryF(function() {
        SyntaxHighlighter.autoload = function(brushes) {
            ...
            if (window.attachEvent)
                window.attachEvent("on" + "load", handler);
            else
        ...
        SyntaxHighlighter.autoload(addPath("/khalalani/js/mangoadmin/js/mylibs/syntaxhighlighter/", [
